...
mimic_icd10 = pd.read_feather(output_dir_icd10 / "mimiciv_icd10_mapped.feather")
...
generate_split(mimic_icd10, output_dir_icd10 / "mimiciv_icd10_mapped_split.feather")
